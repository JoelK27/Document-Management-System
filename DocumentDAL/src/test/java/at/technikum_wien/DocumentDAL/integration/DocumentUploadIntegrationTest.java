...
import at.technikum_wien.DocumentDAL.elasticsearch.DocumentIndexRepository; // <--- Import hinzufügen
...
@ActiveProfiles("test") // Ensure you have application-test.properties or use default
@Transactional
public class DocumentUploadIntegrationTest {
    ...
    // --- ÄNDERUNG HIER ---
    // Mockt das Elasticsearch Repo, damit Spring keine Verbindung zu localhost:9200 versucht
    @MockBean
    ...
    void testUploadDocument() throws Exception {
        ...
        // Perform Upload
        mockMvc.perform(multipart("/api/documents/upload-file") // Stelle sicher, dass dieser Pfad in deinem Controller existiert
                        .file(file)
